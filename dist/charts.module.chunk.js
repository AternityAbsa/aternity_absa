...
/***/ "./src/app/layout/blueprism-servers/blueprism.service.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BlueprismServices; });
var BlueprismServices = /** @class */ (function () {
    function BlueprismServices() {
    }
    return BlueprismServices;
}());
...
module.exports = "<div [@routerTransition]>\r\n    <app-page-header [heading]=\"'Application Monitoring'\"></app-page-header>\r\n    <div class=\"row\">\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                  Absa Monitoring Dashboard\r\n                </div>\r\n                <br>\r\n                <!-- List of Applications  -->\r\n                <div class=\"col col-sm-5\"> \r\n                    <div class=\"card mb-3\"> \r\n                            <select (change)=\"updateData($event)\">\r\n                                <option *ngFor=\"let app of appName\">\r\n                                    {{app}}\r\n                                </option>\r\n                            </select>    \r\n                            <!--<p>\r\n                                <span>{{selectedValue}}</span>\r\n                            </p>  -->                \r\n                    </div>        \r\n\r\n                </div>\r\n\r\n                <!-- List of Machines Dropdown  -->\r\n                <div class=\"col col-sm-5\"> \r\n                    <div class=\"card mb-3\"> \r\n                            <select (change)=\"updateData($event)\">\r\n                                <option *ngFor=\"let blueprism of deviceName\">\r\n                                    {{blueprism}}\r\n                                </option>\r\n                            </select>    \r\n                           <!-- <p>\r\n                                <span>{{selectedValue}}</span>\r\n                            </p> -->                 \r\n                    </div>        \r\n\r\n                </div>\r\n\r\n                 <!-- Timeframe -->\r\n                 <div class=\"col col-sm-5\"> \r\n                        <div class=\"card mb-7\"> \r\n                                <select>\r\n                                    <option *ngFor=\"let time of time_Frame\">\r\n                                        {{time | date: 'medium'}}\r\n                                    </option>\r\n                                </select>\r\n                        </div>\r\n                </div>\r\n\r\n                <div class=\"card-body\">\r\n                    <button class=\"btn btn-info btn-sm\" (change)=\"updateData()\">UpdateData</button>\r\n                </div> \r\n\r\n                <div class=\"card-body\">\r\n                    <canvas *ngIf=\"barChartData\" baseChart [datasets]=\"barChartData\" [labels]=\"barChartLabels\" [options]=\"barChartOptions\" [legend]=\"barChartLegend\" [chartType]=\"barChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas>\r\n                </div>\r\n                <!--<div class=\"card-footer\">\r\n                    <button class=\"btn btn-info btn-sm\" (click)=\"randomize()\">Update</button>\r\n                </div> -->\r\n            </div>\r\n        </div>\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                    Blueprism Doughnut Chart\r\n                </div>\r\n                 <!-- Timeframe\r\n                 <div class=\"col col-sm-5\"> \r\n                    <div class=\"card mb-3\"> \r\n                            <select>\r\n                                <option *ngFor=\"let time of time_Frame\">\r\n                                    {{time | date: 'medium'}}\r\n                                </option>\r\n                            </select>\r\n                    </div>\r\n                 </div> -->\r\n                <div class=\"card-body\"> \r\n                    <canvas baseChart height=\"180px\" [data]=\"doughnutChartData\" [labels]=\"doughnutChartLabels\" [chartType]=\"doughnutChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                  Blueprism Radar Chart\r\n                </div>\r\n                <div class=\"card-body\">\r\n                    <canvas baseChart height=\"180px\" [datasets]=\"radarChartData\" [labels]=\"radarChartLabels\" [chartType]=\"radarChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                 Blueprism Pie Chart\r\n                </div>\r\n                <div class=\"card-body\">\r\n                    <canvas baseChart height=\"150px\" [data]=\"pieChartData\" [labels]=\"pieChartLabels\" [chartType]=\"pieChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas>\r\n                </div>\r\n            </div>\r\n        </div>\r\n    </div>\r\n    <div class=\"row\">\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                    Blueprism Polar Area Chart\r\n                </div>\r\n                <div class=\"card-body\">\r\n                    <canvas baseChart height=\"130px\" [data]=\"polarAreaChartData\" [labels]=\"polarAreaChartLabels\" [legend]=\"polarAreaLegend\" [chartType]=\"polarAreaChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas>\r\n                </div>\r\n            </div>\r\n        </div>\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">\r\n                    Blueprism Line Chart\r\n                </div>\r\n                <div class=\"card-body\">\r\n                    <canvas baseChart height=\"160\" [datasets]=\"lineChartData\" [labels]=\"lineChartLabels\" [options]=\"lineChartOptions\" [colors]=\"lineChartColors\" [legend]=\"lineChartLegend\" [chartType]=\"lineChartType\" (chartHover)=\"chartHovered($event)\" (chartClick)=\"chartClicked($event)\">\r\n                    </canvas> \r\n                </div>\r\n            </div>\r\n        </div>\r\n\r\n        <div class=\"col col-sm-6\">\r\n            <div class=\"card mb-3\">\r\n                <div class=\"card-header\">                       \r\n                          {{data}}                                             \r\n                </div>\r\n           </div>\r\n       </div>\r\n        \r\n\r\n      <div *ngIf=\"chart\">\r\n        <canvas id=\"canvas\">{{ chart }}</canvas>\r\n      </div> \r\n      \r\n\r\n    </div> \r\n</div>  \r\n\r\n<footer class=\"card-footer\">\r\n</footer>\r\n\r\n <!--<p> Sample Data</p>\r\n<div>\r\n<ul>\r\n              <li *ngFor=\"let apps of blueapplication?.value\">\r\n                  {{ apps.SERVING_DEVICE_NAME }} \r\n                  {{ apps.PHYSICAL_MEMORY_UTIL_AVG}} \r\n              </li> \r\n              <li>{{device_name?.value}}</li>\r\n</ul> \r\n</div>  -->\r\n"
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__services_BlueprismService__ = __webpack_require__("./src/app/services/BlueprismService.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__services_DataLoadService__ = __webpack_require__("./src/app/services/DataLoadService.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_rxjs_add_operator_map__ = __webpack_require__("./node_modules/rxjs/_esm5/add/operator/map.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__models_BlueprismModel__ = __webpack_require__("./src/app/models/BlueprismModel.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__blueprism_servers_blueprism_service__ = __webpack_require__("./src/app/layout/blueprism-servers/blueprism.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment_moment__ = __webpack_require__("./node_modules/moment/moment.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_moment_moment___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_7_moment_moment__);
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ChartsComponent = /** @class */ (function () {
    function ChartsComponent(blueprismService, service, dataLoad, dataModel) {
        this.blueprismService = blueprismService;
        this.service = service;
        this.dataLoad = dataLoad;
        this.dataModel = dataModel;
        this.dataArray = [];
        this.timeframe = new Set(['']);
        this.device_name = new Set(['']);
        this.barChartType = 'bar';
        this.barChartLegend = true;
        this.fromDate = __WEBPACK_IMPORTED_MODULE_7_moment_moment__([__WEBPACK_IMPORTED_MODULE_7_moment_moment__().year(), __WEBPACK_IMPORTED_MODULE_7_moment_moment__().month()]);
        this.toDate = __WEBPACK_IMPORTED_MODULE_7_moment_moment__([__WEBPACK_IMPORTED_MODULE_7_moment_moment__().year(), __WEBPACK_IMPORTED_MODULE_7_moment_moment__().month() + 1]);
        this.bar = 'Bar';
        this.dough = 'Dough';
        this.radar = 'Radar';
        // bar chart
        ...
        this.pieChartData = [300, 500, 100, 250, 900, 30];
    ...
    ChartsComponent.prototype.loadBarChart = function () {
        var _this = this;
        this.blueprismService.getBlueprismData().subscribe(function (blue_applications) {
            _this.dataModel.PHYSICAL_MEMORY_UTIL_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.PHYSICAL_MEMORY_UTIL_AVG; });
            var blueBlueRobots = blue_applications['value'].map(function (blue_applications) { return blue_applications.SERVING_DEVICE_NAME; });
            _this.dataModel.CPU_UTILIZATION_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.CPU_UTILIZATION_AVG; });
            _this.dataModel.DISK_QUEUE_LENGTH_MAX = blue_applications['value'].map(function (blue_applications) { return blue_applications.DISK_QUEUE_LENGTH_MAX; });
            var username = blue_applications['value'].map(function (blue_applications) { return blue_applications.USERNAME; });
            _this.dataModel.VIRTUAL_MEMORY_UTIL_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.VIRTUAL_MEMORY_UTIL_AVG; });
            _this.dataModel.NETWORK_READ_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.NETWORK_READ_AVG; });
            _this.dataModel.NETWORK_WRITE_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.NETWORK_WRITE_AVG; });
            _this.dataModel.HOUR_RUNNING_TOTAL = blue_applications['value'].map(function (blue_applications) { return blue_applications.HOUR_RUNNING_TOTAL; });
            _this.dataModel.DISK_IO_READ_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.DISK_IO_READ_AVG; });
            _this.dataModel.DISK_IO_WRITE_AVG = blue_applications['value'].map(function (blue_applications) { return blue_applications.DISK_IO_WRITE_AVG; });
            _this.device_name = blue_applications['value'].map(function (blue_applications) { return blue_applications.SERVING_DEVICE_NAME; });
            _this.timeframe = blue_applications['value'].map(function (blue_applications) { return blue_applications.TIMEFRAME; });
            /** Remove Duplicates **/
            _this.deviceName = new Set(_this.device_name);
            _this.time_Frame = new Set(_this.timeframe);
            console.log(_this.time_Frame);
            _this.barChartData = [
                { data: _this.dataModel.CPU_UTILIZATION_AVG, label: 'CPU Avg' },
                { data: _this.dataModel.PHYSICAL_MEMORY_UTIL_AVG, label: 'MEMORY%' },
                { data: _this.dataModel.DISK_QUEUE_LENGTH_MAX, label: 'DQL' },
                { data: _this.dataModel.VIRTUAL_MEMORY_UTIL_AVG, label: 'Virtual Memory' }
            ];
            _this.allTheData = {
                ...
                drilldown: {
                    'Sunday': {
                        ...
                        bars: [
                            { data: _this.dataModel.DISK_IO_READ_AVG, label: 'DISK_IO_READ_AVG' },
                            { data: _this.dataModel.DISK_IO_WRITE_AVG, label: 'DISK_IO_WRITE_AVG' },
                            { data: _this.dataModel.NETWORK_READ_AVG, label: 'NETWORK_READ_AVG' },
                            { data: _this.dataModel.NETWORK_WRITE_AVG, label: 'NETWORK_WRITE_AVG' }
                        ],
                        drilldown: {
                            '6am': {
                                labels: ['6am', '7am', '8am', '9am', '10am', '11am', '12pm'],
                                bars: [
                                    { data: _this.dataModel.HOUR_RUNNING_TOTAL, label: 'HOUR_RUNNING_TOTAL' },
                                    { data: _this.dataModel.NETWORK_READ_AVG, label: 'NETWORK_READ_AVG' },
                                    { data: _this.dataModel.NETWORK_WRITE_AVG, label: 'NETWORK_WRITE_AVG' }
                                ],
                            }
    ...
    ChartsComponent.prototype.loadDoughnut = function () {
        var _this = this;
        this.blueprismService.deviceInventoryData().subscribe(function (blue_applications) {
            _this.dataModel.DEVICE_CPU_CORES = blue_applications['value'].map(function (blue_applications) { return blue_applications.DEVICE_CPU_CORES; });
            _this.dataModel.AGENT_VERSION = blue_applications['value'].map(function (blue_applications) { return blue_applications.AGENT_VERSION; });
            _this.dataModel.CRASHES = blue_applications['value'].map(function (blue_applications) { return blue_applications.CRASHES; });
            console.log(_this.dataModel.DEVICE_CPU_CORES);
            _this.doughnutChartData = _this.dataModel.DEVICE_CPU_CORES;
        }, function (err) {
            console.log(err);
        });
        return this.doughnutChartData = [0, 0, 0, 0];
    };
    ChartsComponent.prototype.loadRadar = function () {
        var _this = this;
        var radarData = [];
        this.blueprismService.applicationRawData().subscribe(function (blue_applications) {
            _this.dataModel.UXI = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI; });
            _this.dataModel.UXI_WEIGHT = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI_WEIGHT; });
            _this.dataModel.CRASHES = blue_applications['value'].map(function (blue_applications) { return blue_applications.CRASHES; });
            _this.dataModel.PERFORMANCE_INDEX = blue_applications['value'].map(function (blue_applications) { return blue_applications.PERFORMANCE_INDEX; });
            _this.dataModel.ACTIVITY_VOLUME = blue_applications['value'].map(function (blue_applications) { return blue_applications.ACTIVITY_VOLUME; });
            _this.dataModel.HANG_TIME = blue_applications['value'].map(function (blue_applications) { return blue_applications.HANG_TIME; });
            _this.radar_uxi = _this.dataModel.UXI;
            _this.radar_crashes = _this.dataModel.PERFORMANCE_INDEX;
            /*console.log(this.radar_uxi); **/
            radarData = [
                { data: _this.dataModel.UXI, label: 'Series A' },
                { data: _this.dataModel.PERFORMANCE_INDEX, label: 'Series B' }
            ];
            /*console.log(radarData);**/
            console.log(_this.radarChartData);
        }, function (err) {
            console.log(err);
        });
    ...
    ChartsComponent.prototype.loadPie = function () {
        var _this = this;
        this.blueprismService.applicationRawData().subscribe(function (blue_applications) {
            _this.dataModel.UXI = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI; });
            _this.dataModel.UXI_WEIGHT = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI_WEIGHT; });
            ...
            _this.dataModel.ACTIVITY_VOLUME = blue_applications['value'].map(function (blue_applications) { return blue_applications.ACTIVITY_VOLUME; });
            _this.dataModel.HANG_TIME = blue_applications['value'].map(function (blue_applications) { return blue_applications.HANG_TIME; });
            _this.dataModel.APPLICATION = blue_applications['value'].map(function (blue_applications) { return blue_applications.APPLICATION; });
            _this.appName = new Set(_this.dataModel.APPLICATION);
            console.log(_this.dataModel.APPLICATION);
        }, function (err) {
            console.log(err);
        });
        return this.radarChartData = [
    ...
    ChartsComponent.prototype.loadLineChart = function () {
        var _this = this;
        this.blueprismService.applicationRawData().subscribe(function (blue_applications) {
            _this.dataModel.UXI = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI; });
            _this.dataModel.UXI_WEIGHT = blue_applications['value'].map(function (blue_applications) { return blue_applications.UXI_WEIGHT; });
    ...
    ChartsComponent.prototype.getElements = function (arr) {
    ...
    ChartsComponent.prototype.chartClicked = function (e) {
        ...
        var label = e.active[0]._model.label;
    ...
    ChartsComponent.prototype.updateData = function (event) {
        this.loadBarChart();
    ...
    ChartsComponent.prototype.convertDate = function (date) {
    ...
    __decorate([
        ...
        __metadata("design:type", Array)
    ], ChartsComponent.prototype, "applications", void 0);
    ChartsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_6__blueprism_servers_blueprism_service__["a" /* BlueprismServices */]]
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2__services_BlueprismService__["a" /* BlueprismService */], __WEBPACK_IMPORTED_MODULE_6__blueprism_servers_blueprism_service__["a" /* BlueprismServices */], __WEBPACK_IMPORTED_MODULE_3__services_DataLoadService__["a" /* DataLoadService */],
            __WEBPACK_IMPORTED_MODULE_5__models_BlueprismModel__["a" /* BlueprismModel */]])
    ], ChartsComponent);
