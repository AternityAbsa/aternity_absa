...
export interface Application {
  ...
  const data: Application[] = [
       { applications: 'Aziwa', username: 'abrm994', activity: 'A', client_time: 1, device_model: 'x' },
       { applications: 'Fbss', username: 'abrm994', activity: 'B', client_time: 2, device_model: 'x1'},
       { applications: 'Esp', username: 'ablo101', activity: 'C', client_time: 3, device_model: 'x11'},
       { applications: 'Sybrin', username: 'D', activity: 'D', client_time: 4, device_model: 'x111'}
  ];
