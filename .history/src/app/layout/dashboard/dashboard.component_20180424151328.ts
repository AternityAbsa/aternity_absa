...
export interface Application {
  ...
  const data: Application[] = [
       { applications: 'Aziwa', username: 'ablo101', activity: 'A', client_time: 1, device_model: 'x' },
       ...
       { applications: 'Sybrin', username: 'testyuser', activity: 'D', client_time: 4, device_model: 'x111'}
  ];
