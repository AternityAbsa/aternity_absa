...
export interface Application {
  ...
  const data: Application[] = [
       ...
       { applications: 'AZIWEEsp', username: 'testuser', activity: 'Other Pages', client_time: 3, device_model: 'x11'},
       { applications: 'Sybrin', username: 'testuser', activity: 'D', client_time: 4, device_model: 'x111'}
  ];
