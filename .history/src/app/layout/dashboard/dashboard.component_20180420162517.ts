...
export interface Application {
  ...
  const data: Application[] = [
       ...
       { applications: 'B', username: 'A', activity: 'A', client_time: 1},
       { applications: 'C', username: 'A', activity: 'A', client_time: 1},
       { applications: 'D', username: 'A', activity: 'A', client_time: 1}
