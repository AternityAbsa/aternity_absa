...
export class DashboardComponent implements OnInit{
  ...
  dataSource = new appDataSource(this.apps);dataSource = new appDataSource(this.apps);
...
export class appDataSource extends DataSource<any> {
    ...
    connect(): Observable<SampleTest[]> {
        var rows = [];
        this.appService.bestAndWorstUsersData().forEach(element => rows.push(element));
        console.log(rows);
        return Observable.of(rows);

       /* const rows = [];
        console.log('get here');
        let sample = this.appService.bestAndWorstUsersData().forEach(element => rows.push(element, { detailRow: true, element }));
        console.log(this.appService.bestAndWorstUsersData());
