...
export class DashboardComponent implements OnInit{
  ...
  testData(): Element[]{
    ...
    this.apps.bestAndWorstUsersData().subscribe(
        ...
        this.model.CLIENT_TIME = apps['value'].map(apps => apps.BEST_APPLICATION);
...
export interface Application {
  ...
  const data: Application[] = [
       { applications: 'A', username: 'A', activity: 'A', client_time: 1},
       { applications: 'B', username: 'B', activity: 'B', client_time: 2},
       { applications: 'C', username: 'C', activity: 'C', client_time: 3},
       { applications: 'D', username: 'D', activity: 'D', client_time: 4}
  ];
