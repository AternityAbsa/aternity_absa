...
export interface Application {
  ...
  const data: Application[] = [
       ...
       { applications: 'B', username: 'B', activity: 'B', client_time: 1},
       { applications: 'C', username: 'C', activity: 'C', client_time: 1},
       { applications: 'D', username: 'D', activity: 'D', client_time: 1}
