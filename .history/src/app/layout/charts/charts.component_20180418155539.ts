...
export class ChartsComponent implements OnInit{
   ...
   /** private doughnutChartData: number[] = [78, 99, 89, 99];  **/
    ...
    loadLineChart() : any[] {
        ...
        let localLine: Array<any> = new Array(this.lineChartData.length);   
        ...
        this.blueprismService.applicationRawData().subscribe(
            ...
            this.radar_crashes = this.dataModel.PERFORMANCE_INDEX;
              ...
              this.lineChartData =[ { data: [65, 59, 80, 81, 56, 55, 80], label: 'VIRTUAL_MEMORY_UTIL_AVG' },
              ...
              { data: [70, 65, 77, 15, 95, 59, 80], label: 'SERVING_DEVICE_NAME'} ];
                // { data: this.dataModel.UXI, label: 'VIRTUAL_MEMORY_UTIL_AVG' },
                // { data: this.dataModel.UXI_WEIGHT, label: 'PHYSICAL_MEMORY_UTIL_AVG' },
                // { data: this.dataModel.PERFORMANCE_INDEX, label: 'CPU_UTILIZATION_AVG'},
                // { data: this.dataModel.ACTIVITY_VOLUME, label: 'SERVING_DEVICE_NAME'} 
