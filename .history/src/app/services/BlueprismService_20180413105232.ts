...
export class BlueprismService {
    ...
    private device_inventory_api = '/DEVICE_INVENTORY?$filter=(DEVICE_TYPE%20eq%20%27Virtual%20App%20Server%27)&$top=7';
    private application_raw_api = '/APPLICATIONS_RAW?$top=4';
